...
class KeranjangAdapter:
    ListAdapter<Barang, KeranjangAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    inner class ViewHolder(private val binding: ItemKeranjangBinding) :
        ...
        fun bind(barang: Barang) {
            ...
            binding.apply {
                ...
                tvJumlahProduk.text = barang.jumlah.toString()
                tvHargaTotal.text = (barang.jumlah?.times(barang.harga)).toString()
                //TODO Tambahan
